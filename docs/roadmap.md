...
Details live in topic docs — do not duplicate: [security.md](security.md) · [performance.md](performance.md) · [redis.md](redis.md) · [rabbitmq.md](rabbitmq.md).
...
“Payment webhooks, API gateway for one HTTPS host, OpenTelemetry, S3 for uploads.”
