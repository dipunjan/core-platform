...
On your machine: `docker compose up -d` (Mongo, Redis, Rabbit). Rabbit web UI: http://localhost:15672 (user `guest`, password `guest`). Redis: [redis.md](redis.md). How this sits next to the websites: [architecture.md](architecture.md).
